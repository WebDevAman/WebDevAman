...
function PostTemplateOne({
  ...
  return (
    <div className={`${theme === 'light' ? 'shadow-postLight' : 'shadow-postDark'} flex flex-col items-center`}>
      {/* ADV Left */}
      ...
      {/* POST */}
      <main className={`${theme === 'light' ? "bg-white " : ' !text-[#fff] bg-light-black'} max-w-[700px] noscrollbar sm:mx-auto sm:shadow-post sm:rounded-[3px] xl:min-w-[630px] px-[10px] md:px-[50px] py-4 leading-[1.1] `}>
        ...
        <div>
          ...
          {postData.content && (
            <div className={`${theme === 'light' ? 'text-[#222]' : 'text-[#efefef]'} px-2`}>
